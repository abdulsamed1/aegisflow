...
| **D5** | Scanning Schedule | Global Cairo operating window **07:00–18:00, every day (Friday included)**; scanning runs every minute inside the window only. **Amended 2026-08-21:** each 1-min tick repeats the 8-Monday scan `SCAN_BURSTS` times (default 2 ≈ every 30s on Free tier, cap 2 Free / 12 Paid) — 2× stays <50 subrequests/invocation (Free cap) and ≈31k req/day at 3 jobs | Operator decision 2026-08-20; burst amendment 2026-08-21 (operator mandate to use 200k free headroom, free-tier safety cap 2 per code review) — **amends the 2026-08-19 lock (24/7, no window)**; same underlying rationale: no fixed release schedule exists on the portal |
