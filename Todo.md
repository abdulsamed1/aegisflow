...
| نموذج العميل | ✅ **CRUD كامل 2026-08-20** | إضافة/تعديل/حذف + حقول ما قبل التعبئة + قفل BOOKED — الاختبارات 46/46 |
...
| لوحة المشغل (عربية) | ✅ **Premium 2026-08-20** | Alexandria + Bootstrap RTL (CSS فقط، SRI) + skeleton/empty/أخطاء inline — بلا أي تغيير على مسار الحجز |
| الاختبارات | ✅ **33/33 + typecheck نظيف** | 28 وحدة + **5 تكامل Miniflare** (D1 حقيقي، KV، DO، تشفير) |
...
| **مراقب Dry-Run** | 🔄 **حي في الإنتاج (نافذة 07:00–18:00)** | `https://opran-booking.maakebda.workers.dev` — منشور v5631b747 (e37f695) 2026-08-20 |
